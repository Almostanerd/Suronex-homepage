export default function Footer() {
  return (
    <footer className="w-full py-12 px-6 border-t border-white/10 bg-[#050810]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        
        {/* Brand Column */}
        <div className="col-span-1 md:col-span-2">
          <h3 className="text-xl font-bold text-white mb-4">SURONEX</h3>
          <p className="text-gray-400 text-sm max-w-xs">
            Continuous security and compliance for the modern cloud infrastructure. Powered by AI.
          </p>
          <div className="mt-6 flex gap-4 text-gray-400">
            {/* Fake Social Icons  */}
            <div className="flex gap-4">
  {/* X (Twitter) */}
  <a href="#" className="w-8 h-8 flex items-center justify-center rounded bg-white/10 hover:bg-blue-600 transition-colors group">
  ...
  <a href="#" className="w-8 h-8 flex items-center justify-center rounded bg-white/10 hover:bg-blue-600 transition-colors group">
    <svg className="w-5 h-5 fill-gray-400 group-hover:fill-white transition-colors" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between text-xs text-gray-500">
        <p>© 2025 Suronex Inc. All rights reserved.</p>
